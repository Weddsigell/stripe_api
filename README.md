...
### Демо
Проект развернут и доступен по [адресу](http://185.170.153.77)

Для удобства тестирования предоставлен доступ к админ панели по [адресу](http://185.170.153.77/admin/)
```
login: admin
pass: admin123
```
...
* Введите любое 3-значное число для CVC.
* Нажмите «Оплатить».

В случае успеха вы будете перенаправлены на главную страницу.

Проект работает в тестовом режиме, реальные платежи и пользовательские данные отсутствуют. 
